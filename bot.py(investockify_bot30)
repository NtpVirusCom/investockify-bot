#!/usr/bin/env python3
"""
🤖 Investockify Bot — Railway Cost-Optimized Edition (v2.4.0)
==========================================================v.30==
...
THAI_NAME = {
    ...
    "COM7": "คอมเซเว่น", "CPAXT": "ซีพี แอ็กซ์ตร้า", "RBF": "อาร์ แอนด์ บี ฟู้ด",
    "NER": "นอร์ทอีส รับเบอร์", "JMT": "เจ เอ็ม ที เน็ทเวอร์ค", "JMART": "เจ เอ็ม ที",
    ...
    "SISB": "เอสไอเอสบี", "PR9": "พรีเมียร์ การประชุม",
}
